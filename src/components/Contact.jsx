const Contact = () => {
    return (
     <div id='contact' className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
       ...
       <form action="https://getform.io/f/6774076c-6f39-4263-b59f-05828c1d7979" method="POST" encType="multipart/form-data">
        ...
        <div className="flex flex-col py-2">
            ...
            <div className="flex flex-col py-2">
                <label className=" uppercase text-sm py-2">Subject</label>
                <textarea rows='10' className="border-2 rounded-lg p-3 flex border-gray-300" type="text" name="Phone"></textarea>
            </div>
        </div>
