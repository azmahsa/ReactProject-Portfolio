  ...
  return (
    <div id="projects" className="max-w-[1024] m-auto md:pl-20 p-4 py-16">
      ...
      <p className="text-center py-8">
        ...
        aspernatur delectus deserunt similique ipsam ullam necessitatibus
        consequatur recusandae in, ab explicabo ad cum odit eius eaque, aliquid
        neque architecto. Porro.
      </p>
